...
import { CommitauditorHead } from '@/interface/summarypart.interface';
...
function CommitReview() {
    ...
    const [grpSelected] = useState<PropGrp>({
        grpCode: '', grpName: ''
    })
    const [GrpHeaders, setGrpHeaders] = useState<CommitauditorHead[]>([])
    ...
    const columns: ColumnsType<{}> = [
        ...
        },
        {
            ...
            width: '11.5%',
            align: 'right',
            className: 'bg-orange-200 font-bold text-lg',
        }
    ]
                        ...
                        {oMasterGrp.filter(g => g.grpCode !== 'TOTAL').map((group) => {
                            ...
                            return (
                                <div key={group.grpCode} className="mt-10 mb-16">
                                    <h2 className="text-xl font-semibold border border-gray-300 text-center py-6 bg-gray-200">
                                        {group.grpName}
                                    </h2>
