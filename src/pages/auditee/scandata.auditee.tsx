            ...
            <div className="flex flex-col min-h-screen p-2 bg-sky-50">
                ...
                {selectedInfo && selectedInfo.length > 0 ? (
                    selectedInfo.map((item, idx) => (
                        <div className="flex flex-col items-center justify-center gap-3 w-full sm:w-3/4 md:w-2/3 lg:w-1/2" key={idx}>
                            <div className="container w-full rounded-xl border border-black shadow-lg p-2 text-center bg-[#FBFBFB]">
                                <div className="flex flex-col gap-3">
                                    {/* <div className="flex flex-row justify-end">
                                        <div className="w-52 p-3 border border-black rounded-md bg-white text-lg text-black font-semibold text-start">
